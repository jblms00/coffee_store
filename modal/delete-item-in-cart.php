...
<div class="modal fade" id="modallDeleteItemInCart<?php echo $row['product_id'];?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content modal-delete-item">
            <form action="actions/delete-to-cart-function.php" method="post">
                <div class="modal-header">
                    <h1>Remove to My Cart</h1>
